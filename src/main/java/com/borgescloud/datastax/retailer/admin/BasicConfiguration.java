package com.borgescloud.datastax.retailer.admin;
...
public class BasicConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable().authorizeRequests().antMatchers("/**").permitAll()
        ...
        .antMatchers("/webjars/**", "/css/**", "/js/**", "/images/**").permitAll().antMatchers("/api/**").permitAll() // review
                                                                                                                      // API
                                                                                                                      // security
                                                                                                                      // and
                                                                                                                      // ajax
        ...
        .permitAll().antMatchers("/workspaces/foundation/*").permitAll().antMatchers("/management/status", "/docs/*")
